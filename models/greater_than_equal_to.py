...
class GreaterThanEqualTo:
    ...
    @staticmethod
    def get_instance():
        if GreaterThanEqualTo.greater_than_equal_to == None:
            GreaterThanEqualTo.greater_than_equal_to = GreaterThanEqualTo()
        return GreaterThanEqualTo.greater_than_equal_to
